...
// 후방 호환성: BG_DEFAULTS는 BG_BADGES_DEFAULTS의 별칭
export const BG_DEFAULTS = BG_BADGES_DEFAULTS;

/**
 * 커스텀 색상 로드
 * 참고: layout/iconType은 프리뷰 전용이므로 항상 기본값(2line/nerd) 반환
 */
export function loadCustomColors() {
  ...
  // 후방 호환성: bg는 bgBadges의 별칭
  return { fg, bg: bgBadges, bgBadges, bgBars, layout, iconType };
}

/**
 * 커스텀 색상 저장
 * 참고: layout/iconType은 프리뷰 전용이므로 저장하지 않음
 */
