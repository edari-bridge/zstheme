#!/bin/bash
# Chips Layout Module - 요소별 역상 배경색
# 각 요소마다 글자색의 어두운 버전을 배경으로 사용
#
...
C_BG_STATUS=$'\033[48;5;17m'    # Blue(111) → Dark Blue
...
C_BG_TIME=$'\033[48;5;17m'      # Blue(75) → Dark Blue
